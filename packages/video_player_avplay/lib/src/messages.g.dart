...
class RestoreMessage {
  RestoreMessage({required this.playerId, this.url, this.resumeTime});
  ...
  Object encode() {
    return <Object?>[playerId, url, resumeTime];
  }
...
class VideoPlayerAvplayApi {
  ...
  Future<void> suspend(PlayerMessage msg) async {
    final String pigeonVar_channelName =
  ...
  Future<void> restore(RestoreMessage msg) async {
    final String pigeonVar_channelName =
