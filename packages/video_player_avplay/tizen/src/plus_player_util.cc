...
static const std::unordered_map<std::string, plusplayer_property_e>
    kConvertPropertyMap = {
        ...
        {"max-bandwidth", PLUSPLAYER_PROPERTY_MAX_BANDWIDTH},
        ...
        {"dash-stream-info", PLUSPLAYER_PROPERTY_DASH_STREAM_INFO},
        {"http-header", PLUSPLAYER_PROPERTY_HTTP_HEADER},
        {"UNWANTED_RESOLUTION", PLUSPLAYER_PROPERTY_UNWANTED_RESOLUTION},
        {"UNWANTED_FRAMERATE", PLUSPLAYER_PROPERTY_UNWANTED_FRAMERATE},
        {"AUDIO_STREAM_INFO", PLUSPLAYER_PROPERTY_AUDIO_STREAM_INFO},
        {"SUBTITLE_STREAM_INFO", PLUSPLAYER_PROPERTY_SUBTITLE_STREAM_INFO},
        {"VIDEO_STREAM_INFO", PLUSPLAYER_PROPERTY_VIDEO_STREAM_INFO},
