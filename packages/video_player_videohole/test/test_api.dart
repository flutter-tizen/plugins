...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.dispose was null, expected non-null PlayerMessage.');
          api.dispose(arg_msg!);
          return <Object?, Object?>{};
        });
      }
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final PlayerMessage? arg_msg = (args[0] as PlayerMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.play was null, expected non-null PlayerMessage.');
          api.play(arg_msg!);
          return <Object?, Object?>{};
        });
      }
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final PlayerMessage? arg_msg = (args[0] as PlayerMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.position was null, expected non-null PlayerMessage.');
    ...
    }
    {
      ...
      if (api == null) {
        ...
        channel.setMockMessageHandler((Object? message) async {
          ...
          final List<Object?> args = (message as List<Object?>?)!;
          final PlayerMessage? arg_msg = (args[0] as PlayerMessage?);
          assert(arg_msg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.pause was null, expected non-null PlayerMessage.');
          api.pause(arg_msg!);
          return <Object?, Object?>{};
        });
      }
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.VideoPlayerApi.setDisplayRoi', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setDisplayRoi was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final GeometryMessage? arg_arg = (args[0] as GeometryMessage?);
          assert(arg_arg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setDisplayRoi was null, expected non-null GeometryMessage.');
