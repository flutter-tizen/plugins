...
abstract class TestHostVideoPlayerApi {
  ...
  static void setup(TestHostVideoPlayerApi? api, {BinaryMessenger? binaryMessenger}) {
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.VideoPlayerApi.setBufferingConfig', codec, binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMockMessageHandler(null);
      } else {
        channel.setMockMessageHandler((Object? message) async {
          assert(message != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setBufferingConfig was null.');
          final List<Object?> args = (message as List<Object?>?)!;
          final BufferingConfigMessage? arg_arg = (args[0] as BufferingConfigMessage?);
          assert(arg_arg != null, 'Argument for dev.flutter.pigeon.VideoPlayerApi.setBufferingConfig was null, expected non-null BufferingConfigMessage.');
