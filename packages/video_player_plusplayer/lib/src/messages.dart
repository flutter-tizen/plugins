...
class BufferingConfigMessage {
  ...
  Object encode() {
    final Map<Object?, Object?> pigeonMap = <Object?, Object?>{};
    pigeonMap['textureId'] = textureId;
    pigeonMap['bufferOption'] = bufferOption;
    pigeonMap['amount'] = amount;
    return pigeonMap;
  }

  static BufferingConfigMessage decode(Object message) {
    final Map<Object?, Object?> pigeonMap = message as Map<Object?, Object?>;
    return BufferingConfigMessage(
      textureId: pigeonMap['textureId']! as int,
      bufferOption: pigeonMap['bufferOption']! as String,
...
class VideoPlayerApi {
  ...
  Future<bool> setBufferingConfig(BufferingConfigMessage arg_arg) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
