# ewk_webview_flutter_tizen

[![pub package](https://img.shields.io/pub/v/ewk_webview_flutter_tizen.svg)](https://pub.dev/packages/ewk_webview_flutter_tizen)
...
This package is not an _endorsed_ implementation of `webview_flutter`. Therefore, you have to include `ewk_webview_flutter_tizen` alongside `webview_flutter` as dependencies in your `pubspec.yaml` file.

```yaml
dependencies:
  webview_flutter: ^3.0.4
  ewk_webview_flutter_tizen: ^0.5.0
```
