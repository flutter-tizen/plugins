...
class FlutterPeerConnectionObserver {
  ...
  //                                 scoped_refptr<RTCPeerConnection>
  //                                 peerconnection, BinaryMessenger* messenger,
...
class FlutterPeerConnection {
  ...
  //   scoped_refptr<RTCRtpTransceiver> getRtpTransceiverById(RTCPeerConnection*
  //   pc,
  //                                                          std::string id);
