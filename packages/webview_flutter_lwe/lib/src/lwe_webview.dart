...
class LweWebView {
  ...
  void onCreate(int viewId) {
    _isCreated = true;
    _lweWebViewChannel = MethodChannel(kLweWebViewChannelName + viewId.toString());
  ...
  Future<void> addJavaScriptChannel(JavaScriptChannelParams javaScriptChannelParams) {
    ...
    if (_javaScriptChannelParams.containsKey(javaScriptChannelParams.name)) {
      _invokeChannelMethod<void>('removeJavaScriptChannel', javaScriptChannelParams.name);
    }
  ...
  Future<void> removeJavaScriptChannel(String javaScriptChannelName) async {
    final JavaScriptChannelParams? params = _javaScriptChannelParams[javaScriptChannelName];
    ...
    return _invokeChannelMethod<void>('removeJavaScriptChannel', javaScriptChannelName);
  }
