...
#ifndef TIZEN_CION_CLIENT_H
#define TIZEN_CION_CLIENT_H
...
class CionClientManager {
 public:
  static void Init(EventSink sync);
  static CionResult Connect(cion_client_h handle, cion_peer_info_h peer_info);
  static CionResult TryDiscovery(cion_client_h handle);

 private:
  static void OnConnectionResult(const char* service_name,
                                 const cion_peer_info_h peer_info,
                                 const cion_connection_result_h result,
                                 void* user_data);
  ...
  static void OnDisconnectedEvent(const char* service_name,
                                  const cion_peer_info_h peer_info,
                                  void* user_data);
  static void OnDiscovered(const char* service_name,
