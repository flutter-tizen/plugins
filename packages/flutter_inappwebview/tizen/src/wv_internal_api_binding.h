...
typedef double (*WvViewLoadProgressGetFnPtr)(wv_view_h view);
typedef bool (*WvViewScaleSetFnPtr)(wv_view_h view, double scale_factor, int cx,
                                    int cy);
typedef double (*WvViewScaleGetFnPtr)(wv_view_h view);
...
typedef struct {
  ...
  WvViewLoadProgressGetFnPtr LoadProgressGet = nullptr;
  WvViewScaleSetFnPtr ScaleSet = nullptr;
  WvViewScaleGetFnPtr ScaleGet = nullptr;
