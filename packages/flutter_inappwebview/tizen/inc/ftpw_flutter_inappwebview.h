...
Ewk_Console_Message_Level
ftpw_flutter_inappwebview_ewk_console_message_level_get(const void* message);
const char* ftpw_flutter_inappwebview_ewk_console_message_text_get(
    const void* message);

int ftpw_flutter_inappwebview_wv_init(void);
int ftpw_flutter_inappwebview_wv_shutdown(void);
int ftpw_flutter_inappwebview_wv_set_arguments(int argc, const char** argv);
void* ftpw_flutter_inappwebview_wv_view_create(void);
void ftpw_flutter_inappwebview_wv_view_destroy(void* view);
void ftpw_flutter_inappwebview_wv_view_resize(void* view, int w, int h);
bool ftpw_flutter_inappwebview_wv_view_focus_set(void* view, int focused);
bool ftpw_flutter_inappwebview_wv_view_url_set(void* view, const char* url);
const char* ftpw_flutter_inappwebview_wv_view_url_get(void* view);
bool ftpw_flutter_inappwebview_wv_view_url_request_set(void* view,
                                                       const char* url,
                                                       wv_http_method_e method,
                                                       void* headers,
                                                       const char* body);
bool ftpw_flutter_inappwebview_wv_view_html_string_load(
    void* view, const char* html, const char* base_url,
    const char* unreachable_url);
bool ftpw_flutter_inappwebview_wv_view_back_possible(void* view);
bool ftpw_flutter_inappwebview_wv_view_forward_possible(void* view);
bool ftpw_flutter_inappwebview_wv_view_back(void* view);
bool ftpw_flutter_inappwebview_wv_view_forward(void* view);
bool ftpw_flutter_inappwebview_wv_view_reload(void* view);
bool ftpw_flutter_inappwebview_wv_view_stop(void* view);
void ftpw_flutter_inappwebview_wv_view_suspend(void* view);
void ftpw_flutter_inappwebview_wv_view_resume(void* view);
const char* ftpw_flutter_inappwebview_wv_view_title_get(void* view);
double ftpw_flutter_inappwebview_wv_view_load_progress_get(void* view);
bool ftpw_flutter_inappwebview_wv_view_scale_set(void* view,
                                                 double scale_factor, int cx,
                                                 int cy);
double ftpw_flutter_inappwebview_wv_view_scale_get(void* view);
bool ftpw_flutter_inappwebview_wv_view_user_agent_set(void* view,
                                                      const char* user_agent);
const char* ftpw_flutter_inappwebview_wv_view_user_agent_get(void* view);
bool ftpw_flutter_inappwebview_wv_view_scroll_set(void* view, int x, int y);
bool ftpw_flutter_inappwebview_wv_view_scroll_pos_get(void* view, int* x,
                                                      int* y);
bool ftpw_flutter_inappwebview_wv_view_script_execute(
    void* view, const char* script, wv_view_script_execute_cb callback,
    void* user_data);
bool ftpw_flutter_inappwebview_wv_view_bg_color_set(void* view, int r, int g,
                                                    int b, int a);
void* ftpw_flutter_inappwebview_wv_view_context_get(void* view);
void* ftpw_flutter_inappwebview_wv_view_settings_get(void* view);
bool ftpw_flutter_inappwebview_wv_view_feed_touch_event(
    void* view, wv_touch_event_type_e event_type, void* points,
    wv_modifier_e modifiers);
int ftpw_flutter_inappwebview_wv_view_feed_mouse_down(
    void* view, wv_mouse_button_type_e button, int x, int y);
int ftpw_flutter_inappwebview_wv_view_feed_mouse_up(
    void* view, wv_mouse_button_type_e button, int x, int y);
int ftpw_flutter_inappwebview_wv_view_feed_mouse_wheel(void* view,
                                                       bool y_direction,
                                                       int step, int x, int y);
bool ftpw_flutter_inappwebview_wv_view_send_key_event(
    void* view, const wv_key_event_s* key_event, int is_press);
bool ftpw_flutter_inappwebview_wv_view_touch_events_enabled_set(void* view,
                                                                int enabled);
bool ftpw_flutter_inappwebview_wv_view_mouse_events_enabled_set(void* view,
                                                                bool enabled);
bool ftpw_flutter_inappwebview_wv_view_key_events_enabled_set(void* view,
                                                              bool enabled);
void ftpw_flutter_inappwebview_wv_view_ime_window_set(void* view, void* window);
int ftpw_flutter_inappwebview_wv_view_add_cb(void* view, const char* event,
                                             wv_view_cb func,
                                             const void* user_data);
int ftpw_flutter_inappwebview_wv_view_remove_full_cb(void* view,
                                                     const char* event,
                                                     wv_view_cb func,
                                                     const void* user_data);
int ftpw_flutter_inappwebview_wv_view_javascript_alert_callback_set(
    void* view, wv_view_javascript_alert_cb callback, void* user_data);
int ftpw_flutter_inappwebview_wv_view_javascript_confirm_callback_set(
    void* view, wv_view_javascript_confirm_cb callback, void* user_data);
int ftpw_flutter_inappwebview_wv_view_javascript_prompt_callback_set(
    void* view, wv_view_javascript_prompt_cb callback, void* user_data);
void ftpw_flutter_inappwebview_wv_view_javascript_alert_reply(void* view);
void ftpw_flutter_inappwebview_wv_view_javascript_confirm_reply(void* view,
                                                                bool result);
void ftpw_flutter_inappwebview_wv_view_javascript_prompt_reply(
    void* view, const char* result);
bool ftpw_flutter_inappwebview_wv_view_set_support_video_hole(
    void* view, void* window, bool enable, bool is_video_window);
bool ftpw_flutter_inappwebview_wv_view_main_frame_scrollbar_visible_set(
    void* view, bool visible);
void* ftpw_flutter_inappwebview_wv_context_cookie_manager_get(void* context);
bool ftpw_flutter_inappwebview_wv_context_cache_model_set(
    void* context, wv_cache_model_e model);
bool ftpw_flutter_inappwebview_wv_context_cache_clear(void* context);
void ftpw_flutter_inappwebview_wv_cookie_manager_accept_policy_set(
    void* manager, wv_cookie_accept_policy_e policy);
void ftpw_flutter_inappwebview_wv_cookie_manager_cookies_clear(void* manager);
bool ftpw_flutter_inappwebview_wv_settings_javascript_enabled_set(
    void* settings, bool enable);
void ftpw_flutter_inappwebview_wv_settings_ime_panel_enabled_set(void* settings,
                                                                 bool enable);
bool ftpw_flutter_inappwebview_wv_settings_force_zoom_set(void* settings,
                                                          bool enable);
int ftpw_flutter_inappwebview_wv_error_code_get(void* error);
const char* ftpw_flutter_inappwebview_wv_error_description_get(void* error);
const char* ftpw_flutter_inappwebview_wv_error_url_get(void* error);
bool ftpw_flutter_inappwebview_wv_policy_decision_use(void* policy_decision);
const char* ftpw_flutter_inappwebview_wv_policy_decision_url_get(
    void* policy_decision);
wv_console_message_level_e
ftpw_flutter_inappwebview_wv_console_message_level_get(void* message);
const char* ftpw_flutter_inappwebview_wv_console_message_text_get(
    void* message);
...
#endif  // FLUTTER_TIZEN_PLUGINS_WRAPPER_FLUTTER_INAPPWEBVIEW_H_
