...
class RpcportProxyTizenPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrar *registrar) {
    ...
    auto plugin = std::make_unique<RpcportProxyTizenPlugin>(registrar);
  ...
  RpcportProxyTizenPlugin(flutter::PluginRegistrar *pluginRegistrar)
      : plugin_registrar_(pluginRegistrar) {}

  virtual ~RpcportProxyTizenPlugin() {}
 ...
 private:
  ...
  void CheckForRemote(
    ...
    RpcportProxyResult native_result = manager_.CheckRemotePort(
    ...
    auto event_channel_handler =
        std::make_unique<flutter::StreamHandlerFunctions<>>(
            [this, key](const flutter::EncodableValue *arguments,
              ...
              RpcportProxyResult native_result = manager_.RegisterLocalPort(
            ...
            [this, key](const flutter::EncodableValue *arguments)
              ...
              RpcportProxyResult native_result =
...
void MessageportTizenPluginRegisterWithRegistrar(
  ...
  RpcportProxyTizenPlugin::RegisterWithRegistrar(
