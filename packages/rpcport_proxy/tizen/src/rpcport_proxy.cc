...
RpcportProxyManager::RpcportProxyManager() {}
...
void RpcportProxyManager::OnMessageReceived(int local_port_id,
  ...
  RpcportProxyManager* manager = static_cast<RpcportProxyManager*>(user_data);
...
RpcportProxyResult RpcportProxyManager::RegisterLocalPort(
...
RpcportProxyResult RpcportProxyManager::UnregisterLocalPort(int local_port_id) {
...
RpcportProxyResult RpcportProxyManager::CheckRemotePort(
...
RpcportProxyResult RpcportProxyManager::Send(std::string& remote_app_id,
  ...
  RpcportProxyResult result = PrepareBundle(message, bundle);
  if (!result) {
    return result;
  }
...
RpcportProxyResult RpcportProxyManager::PrepareBundle(
...
RpcportProxyResult RpcportProxyManager::CreateResult(int return_code) {
  RpcportProxyResult result(return_code);
