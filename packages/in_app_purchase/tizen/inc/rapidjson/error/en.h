...
/*!
    ...
    \note User can make a copy of this function for localization.
        Using switch-case is safer for future modification of error codes.
*/
inline const RAPIDJSON_ERROR_CHARTYPE* GetValidateError_En(
  ...
  switch (validateErrorCode) {
    ...
    case kValidateErrorMultipleOf:
      return RAPIDJSON_ERROR_STRING(
          "Number '%actual' is not a multiple of the 'multipleOf' value "
          "'%expected'.");
    ...
    case kValidateErrorMinLength:
      return RAPIDJSON_ERROR_STRING(
          "String '%actual' is shorter than the 'minLength' value "
          "'%expected'.");
    ...
    case kValidateErrorMaxItems:
      return RAPIDJSON_ERROR_STRING(
          "Array of length '%actual' is longer than the 'maxItems' value "
          "'%expected'.");
    case kValidateErrorMinItems:
      return RAPIDJSON_ERROR_STRING(
          "Array of length '%actual' is shorter than the 'minItems' value "
          "'%expected'.");
    ...
    case kValidateErrorRequired:
      return RAPIDJSON_ERROR_STRING(
          "Object is missing the following members required by the schema: "
          "'%missing'.");
    ...
    case kValidateErrorEnum:
      return RAPIDJSON_ERROR_STRING(
          "Property has a value that is not one of its allowed enumerated "
          "values.");
    ...
    case kValidateErrorReadOnly:
      return RAPIDJSON_ERROR_STRING(
          "Property is read-only but has been provided when validation is for "
          "writing.");
    case kValidateErrorWriteOnly:
      return RAPIDJSON_ERROR_STRING(
          "Property is write-only but has been provided when validation is for "
          "reading.");
...
/*!
   ...
   of error codes.
*/
inline const RAPIDJSON_ERROR_CHARTYPE* GetSchemaError_En(
  ...
  switch (schemaErrorCode) {
    ...
    case kSchemaErrorStartUnknown:
      return RAPIDJSON_ERROR_STRING(
          "Pointer '%value' to start of schema does not resolve to a location "
          "in the document.");
    ...
    case kSchemaErrorRefPointerInvalid:
      return RAPIDJSON_ERROR_STRING(
          "$ref fragment '%value' is not a valid JSON pointer at offset "
          "'%offset'.");
    case kSchemaErrorRefUnknown:
      return RAPIDJSON_ERROR_STRING(
          "$ref '%value' does not resolve to a location in the target "
          "document.");
    ...
    case kSchemaErrorRefNoRemoteSchema:
      return RAPIDJSON_ERROR_STRING(
          "$ref '%value' is remote but the remote provider did not return a "
          "schema.");
    case kSchemaErrorRegexInvalid:
      return RAPIDJSON_ERROR_STRING(
          "Invalid regular expression '%value' in 'pattern' or "
          "'patternProperties'.");
